...
This project is developed with OpenAI Codex and Cursor on top of the **AI-Human Cowork Framework**.
This file is the **project context entrypoint** that OpenAI Codex and Cursor read at session start.
...
1. Read this file (`AGENTS.md`) and understand the project context and collaboration rules.
...
OpenAI Codex or Cursor automatically performs the following without separate permission:
...
| Trigger | Codex / Cursor Automatic Action |
|--------|---------------------------|
...
| Context change | Automatically update this file (`AGENTS.md`) |
...
Start naturally from the project root after opening Codex or Cursor.
...
```text
Read AGENTS.md and resume from the current project state.
...
> Fill the items below when the project starts. OpenAI Codex or Cursor automatically updates them when they change.
